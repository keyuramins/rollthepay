...
export function transformDbRowToOccupationRecord(row: DbOccupationRow): OccupationRecord {
  ...
  return {
    ...
    // Related salary ranges (all null - computed dynamically)
    relLinkLow1: null,
    relLinkLow2: null,
    relLinkLow3: null,
    relLinkLow4: null,
    ...
    // Related slugs (all null - computed dynamically)
    relLinkSlug1: null,
    relLinkSlug2: null,
    relLinkSlug3: null,
    relLinkSlug4: null,
    ...
    // Related states (all null - computed dynamically)
    relLinkState1: null,
    relLinkState2: null,
    relLinkState3: null,
    relLinkState4: null,
    ...
    // Related locations (all null - computed dynamically)
    relLinkLoc1: null,
    relLinkLoc2: null,
    relLinkLoc3: null,
    relLinkLoc4: null,
