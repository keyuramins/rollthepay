         ...
         <div className="grid grid-cols-1 gap-8">
          ...
          <div className="bg-chart-1/5 rounded-xl p-8 border border-border">
            <div className="flex items-center mb-6">
              <div className="w-10 h-10 bg-chart-1/5 rounded-lg flex items-center justify-center mr-4">
                  <Logs className="w-6 h-6 text-chart-1" />
              </div>
              <h3 className="text-2xl font-bold text-foreground">Related Opportunities</h3>
            </div>
            ...
            <div className="space-y-4">
              ...
              {relatedOccupations.length > 0 && (
                <div className="bg-background rounded-lg p-4 border border-border">
                  <h4 className="font-semibold text-foreground mb-3">Explore Related Roles</h4>
        ...
        {/* <div className="mt-12 bg-gray-50 rounded-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-foreground mb-2">Network Building</h4>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-foreground mb-2">Skill Certification</h4>
              <p className="text-muted-foreground text-sm">
