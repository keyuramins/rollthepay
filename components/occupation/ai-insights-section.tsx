        ...
        <CardContent>
            ...
            <div className="additional-metrics">
                <div className="salary-metric salary-metric--secondary">
                  <div className="metric-value">{data.percentileRankOrdinal}</div>
                  <div className="metric-label">Position in salary range</div>
                </div>
                <div className="salary-metric salary-metric--secondary">
                  <div className="metric-value">+{data.entryLevelComparison}%</div>
                ...
                <div className="salary-metric salary-metric--secondary">
                  <div className="metric-value">{data.projectedIncreaseRange}</div>
                  <div className="metric-label">{data.nextYear} Projected increase</div>
                </div>
            </div>
      </CardContent>
    </Card>
