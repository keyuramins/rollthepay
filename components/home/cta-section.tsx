  ...
  return (
    <section className="bg-blue-600 py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-2xl sm:text-3xl font-bold text-white sm:text-4xl mb-4 sm:mb-6 px-2">
          Discover What A Job Pays Before You Apply
        </h2>
        <p className="text-lg sm:text-xl text-blue-100 mb-6 sm:mb-8 max-w-3xl mx-auto px-2">
