    ...
    <section className="bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 sm:text-4xl px-2">
        ...
        <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="text-center p-4 sm:p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-sm sm:text-base text-gray-600">Find salary information with simple search terms and filters</p>
          </div>
          ...
          <div className="text-center p-4 sm:p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Accurate Data</h3>
            <p className="text-sm sm:text-base text-gray-600">Gathered directly from employees and employers</p>
          </div>

          <div className="text-center p-4 sm:p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow md:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Global Coverage</h3>
            <p className="text-sm sm:text-base text-gray-600">Salary data from countries around the world</p>
          </div>
        </div>
      </div>
    </section>
