...
export async function generateMetadata(): Promise<Metadata> {
  const stats = { totalRecords: 360000, uniqueCountries: 111 }; // fallback values
  return {
    title: "RollThePay - Discover What Jobs Really Pay Worldwide",
    description: `Get accurate, up-to-date salary data from ${stats.totalRecords}+ records across ${stats.uniqueCountries}+ countries.`,
